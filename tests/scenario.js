const scenario = {
  'Bob mint cETH 和 cWETH 到流動池':
    'Bob should mint cETH and cWETH and liquidate the pool',
};
 ...
 * 2. Bob mint 100 cETH, 100 cWETH 到流動池
 * 2. Alice 抵押 100 ETH，得到 80 ETH 的 liquidity
